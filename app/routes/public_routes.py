...
from app.models import Course  # Asegúrate de importar el modelo de Course
...
def home():
    ...
    if 'user_id' in session:
        ...
        user_courses = [course.id for course in session.get('user_courses', [])]  # Asegúrate de obtener los cursos correctamente
